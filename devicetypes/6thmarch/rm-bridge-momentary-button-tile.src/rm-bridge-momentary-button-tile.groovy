 ...
 *	
 *	RM Bridge Momentary Button Tile 
 *	Version : 1.0.1
 * 
 * 	Description:
 * 		RM Bridge Momentary Button Tile is a SmartThings Device Type that allows you to turn on or off devices 
 ...
 *
 *  2015-12-22  V1.0.0  Initial release
 *	2016-02-29	V1.0.1	Renamed device type
 */
 
metadata {
	definition (name: "RM Bridge Momentary Button Tile", 
