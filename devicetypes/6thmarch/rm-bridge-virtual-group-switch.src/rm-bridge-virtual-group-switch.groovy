 ...
 *	
 *	RM Bridge Virtual Group Switch 
 *	Version : 1.0.1
 * 
 * 	Description:
 * 		RM Bridge Virtual Group Switch is a SmartThings Device Type that allows you to turn on or off devices 
 ...
 *	https://github.com/6thmarch/SmartThingsPersonal/blob/master/devicetypes/6thmarch/broadlink-rm-virtual-group-switch.src/broadlink-rm-virtual-group-switch.groovy
 *
...
metadata {
    ...
    definition (
    name: "RM Bridge Virtual Group Switch",
